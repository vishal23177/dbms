...
<head>
    ...
    <title>Register for Placement</title>
    <style>
        body{
...
<body>
    <h1>Register for Placement and Training Events</h1>
    <?php
    ...
    $sql = "SELECT * FROM placement"; // Assuming 'culturals' is your table name
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo '<div class="table-container">';
        echo '<table border="1">';
        echo '<tr><th>Event ID</th><th>Event Name</th><th>Date and Time</th><th>Venue</th><th>Company Name</th><th>Officer Name</th><th>Description</th><th>Participants</th><th>Action</th></tr>';
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td>';
            echo '<form method="post" action="registerplacement.php">';
