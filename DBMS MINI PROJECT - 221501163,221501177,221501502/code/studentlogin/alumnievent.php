...
<head>
    ...
    <title>Register for alumni Event</title>
    <style>
        body{
...
<body>
    <h1>Register for Alumni Events</h1>
    <?php
    ...
    $sql = "SELECT * FROM alumni"; // Assuming 'culturals' is your table name
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo '<div class="table-container">';
        echo '<table border="1">';
        echo '<tr><th>Event ID</th><th>Event Name</th><th>Date and Time</th><th>Venue</th><th>Description</th><th>Alumni Name</th><th>Alumni Position</th><th>Action</th></tr>';
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td>' . $row['alumniPosition'] . '</td>';

            echo '<td>';
            echo '<form method="post" action="registeralumni.php">';
