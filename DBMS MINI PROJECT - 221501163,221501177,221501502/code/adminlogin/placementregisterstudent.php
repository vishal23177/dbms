...
<head>
    ...
    <title>Students Register for Placement Events</title>
    <style>
        body{
...
<body>
    <h1>Students Register for Placement Events</h1>
    <?php
    ...
    $sql = "SELECT * FROM placementregister"; // Assuming 'culturals' is your table name
