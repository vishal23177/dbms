...
<head>
    ...
    <title>Added Academic Event Management</title>
    <style>
        body{
...
<body>
    <h1>Added Academic Event Management</h1>
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE academic SET eventName='$eventName', domainName='$domainName', eventDateTime='$eventDateTime', eventVenue='$eventVenue', eventDescription='$eventDescription', eventParticipants='$eventParticipants' WHERE eventid=$eventid";
...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM academic WHERE eventid=$eventid";
...
if ($result->num_rows > 0) {
    echo '<table border="1">';
    echo '<tr><th>Event ID</th><th>Event Name</th><th>Domain Name</th><th>Date and Time</th><th>Venue</th><th>Description</th><th>Participants</th><th>Actions</th></tr>';
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td><input type="text" name="domainName" value="' . $row['domainName'] . '"></td>';
