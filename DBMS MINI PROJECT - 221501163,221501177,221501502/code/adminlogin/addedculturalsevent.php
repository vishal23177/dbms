...
<head>
    ...
    <title>Added Culturals Event Management</title>
    <style>
        body{
...
<body>
    <h1>Added Culturals Event Management</h1>
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE culturals SET eventName='$eventName', eventDateTime='$eventDateTime', eventVenue='$eventVenue', eventDescription='$eventDescription', eventParticipants='$eventParticipants' WHERE eventid=$eventid";
...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM culturals WHERE eventid=$eventid";
...
if ($result->num_rows > 0) {
    echo '<table border="1">';
    echo '<tr><th>Event ID</th><th>Event Name</th><th>Date and Time</th><th>Venue</th><th>Description</th><th>Participants</th><th>Actions</th></tr>';
