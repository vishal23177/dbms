...
<head>
    ...
    <title>Added Alumni Event Management</title>
    <style>
        body{
...
<body>
    <h1>Added Alumni Event Management</h1>
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE alumni SET eventName='$eventName', eventDateTime='$eventDateTime', eventVenue='$eventVenue', eventDescription='$eventDescription', alumniName='$alumniName', alumniPosition='$alumniPosition'  WHERE eventid=$eventid";
...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM alumni WHERE eventid=$eventid";
...
if ($result->num_rows > 0) {
    echo '<table border="1">';
    echo '<tr><th>Event ID</th><th>Event Name</th><th>Date and Time</th><th>Venue</th><th>Description</th><th>alumniName</th><th>alumniPosition</th><th>Actions</th></tr>';
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td><input type="text" name="alumniName" value="' . $row['alumniName'] . '"></td>';
        echo '<td><input type="text" name="alumniPosition" value="' . $row['alumniPosition'] . '"></td>';
        echo '<td>';
