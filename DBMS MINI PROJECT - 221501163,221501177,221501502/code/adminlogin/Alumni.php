...
<style>
    ...
    body{
        background-size: cover;
            ...
            background-image: url('adminimage/alumini.jpg');
    }
    .container {
        max-width: 600px;
        margin: 0 auto;
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" id="alumniName" name="alumniName" required>
        </div>
        <div class="form-group">
            <label for="alumniPosition">Alumni Position:</label>
            <input type="text" id="alumniPosition" name="alumniPosition" required>
        </div>
